...
<body>
    ...
    <section class="blog-details-hero set-bg" data-setbg="{{asset('view/img/blog/blog-details/blog-details-hero.jpg')}}">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="blog-details-text">
                        ...
                        <div class="bd-pic">
                            <div class="bp-item">
                                <img src="{{asset('view/img/blog/blog-details/blog-details-1.jpg')}}" alt="">
                            </div>
                            <div class="bp-item">
                                <img src="{{asset('view/img/blog/blog-details/blog-details-2.jpg')}}" alt="">
                            </div>
                            <div class="bp-item">
                                <img src="{{asset('view/img/blog/blog-details/blog-details-3.jpg')}}" alt="">
                            </div>
                        </div>
                        ...
                        <div class="comment-option">
                            ...
                            <div class="single-comment-item first-comment">
                                <div class="sc-author">
                                    <img src="{{asset('view/img/blog/blog-details/avatar/avatar-1.jpg')}}" alt="">
                                </div>
                                <div class="sc-text">
                            ...
                            <div class="single-comment-item reply-comment">
                                <div class="sc-author">
                                    <img src="{{asset('view/img/blog/blog-details/avatar/avatar-2.jpg')}}" alt="">
                                </div>
                                <div class="sc-text">
                                    <span>27 Aug 2019</span>
                                    <h5>Brandon Kelley</h5>
                            ...
                            <div class="single-comment-item second-comment ">
                                <div class="sc-author">
                                    <img src="{{asset('view/img/blog/blog-details/avatar/avatar-3.jpg')}}" alt="">
                                </div>
                                <div class="sc-text">
                                    <span>27 Aug 2019</span>
                                    <h5>Brandon Kelley</h5>
