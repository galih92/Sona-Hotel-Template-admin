    ...
    <section class="blog-section blog-page spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{asset('view/img/blog/blog-1.jpg')}}">
                        <div class="bi-text">
                            ...
                            <h4><a href="/detail_news">Tremblant In Canada</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{asset('view/img/blog/blog-4.jpg')}}">
                        <div class="bi-text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{asset('view/img/blog/blog-5.jpg')}}">
                        <div class="bi-text">
                            <span class="b-tag">Camping</span>
                            <h4><a href="./blog-details.html">A Time Travel Postcard</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{asset('view/img/blog/blog-6.jpg')}}">
                        <div class="bi-text">
                            <span class="b-tag">Travel Trip</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{asset('view/img/blog/blog-7.jpg')}}">
                        <div class="bi-text">
                            <span class="b-tag">Travel Trip</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{asset('view/img/blog/blog-8.jpg')}}">
                        <div class="bi-text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="{{asset('view/img/blog/blog-9.jpg')}}">
                        <div class="bi-text">
                            <span class="b-tag">Camping</span>
